...
//   if (user?.Job_role === "manager") return <AdminDashboard />;
//   if (user?.Job_role === "employee") return <EmployeeDashboard />;
...
const ProfilePage = () => (
  <div className="p-6">
    <h1 className="page-title">Profile</h1>
    <p className="page-description">Profile functionality will be implemented here.</p>
  </div>
);
        ...
        <div className="App">
          <Routes>
            ...
            <Route path="/" element={<ProtectedRoute><Layout /></ProtectedRoute>}>
              ...
              {/* Manager Routes */}
              <Route path="employees" element={<ProtectedRoute requiredRole="manager"><EmployeesPage /></ProtectedRoute>} />
              <Route path="projects" element={<ProtectedRoute requiredRole="manager"><ProjectsPage /></ProtectedRoute>} />
              <Route path="tasks" element={<ProtectedRoute requiredRole="manager"><TasksPage /></ProtectedRoute>} />
              <Route path="calendar" element={<ProtectedRoute requiredRole="manager"><CalendarPage /></ProtectedRoute>} />
              <Route path="capacity" element={<ProtectedRoute requiredRole="manager"><CapacityPage /></ProtectedRoute>} />
              ...
              <Route path="my-projects" element={<ProtectedRoute requiredRole="employee"><MyProjectsPage /></ProtectedRoute>} />
              <Route path="schedule" element={<ProtectedRoute requiredRole="employee"><SchedulePage /></ProtectedRoute>} />
              <Route path="timesheet" element={<ProtectedRoute requiredRole="employee"><TimesheetPage /></ProtectedRoute>} />
          ...
          <Toaster
            ...
            toastOptions={{
              ...
              success: { duration: 3000, theme: { primary: '#22c55e', secondary: '#fff' } },
